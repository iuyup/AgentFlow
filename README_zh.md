...
| [Hierarchical（层级委派）](patterns/hierarchical/) | Manager 分解任务 → Workers 执行 → Manager 汇总 | 嵌套子图 + Send | ✅ |
| [Voting（投票决策）](patterns/voting/) | 多 Agent 独立投票后聚合 | 广播扇出 | ✅ |
| [GuardRail（风控守门）](patterns/guardrail/) | 主 Agent + 安全守门检查点 | Approve/block/redirect 路由 | ✅ |
| [RAG-Agent（检索增强）](patterns/rag_agent/) | Agent 自主决定何时从知识库检索 | 条件检索循环 | ✅ |
